...
from errors import LexicographicError, SyntaticError
...
if __name__ == "__main__":
    ...
    data = open('string4.rm', encoding='utf-8')
    data = data.read()
...
# t_AGENTS = r'AGENT'        # AGENTS
# t_ENVIRONMENT = r'ENVIRONMENT'   # ENVIRONMENT
# t_MAP = r'MAP'           # MAP
# t_STAGES = r'STAGES'  # STAGES
# t_SEMAPHORES = r'SEMAPHORES'     # SEMAPHORES
# t_DEPOT = r'DEPOT'         # DEPOT
# t_BUS_STOP = r'BUS_STOP'      # BUS_STOP
# t_COMPANY = r'COMPANY'       # COMPANY
# t_VEHICLE = r'VEHICLE'       # VEHICLE
# t_CLIENT = r'CLIENT'        # CLIENT
# t_FIRM = r'FIRM'          # FIRM
